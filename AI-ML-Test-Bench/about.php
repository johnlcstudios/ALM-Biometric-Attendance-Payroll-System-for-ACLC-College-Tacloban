...
<body>
            ...
            <div class="billboard-content">
                ...
                <div class="team-container">
                    ...
                    <div class="team-controls" role="tablist" aria-label="Developer Teams">
                        <button class="team-btn active" id="tab-leads" role="tab" aria-selected="true" aria-controls="team-leads" tabindex="0" onclick="toggleTeam('team-leads', this)">01. Leads</button>
                        <button class="team-btn" id="tab-admin" role="tab" aria-selected="false" aria-controls="admin-team" tabindex="-1" onclick="toggleTeam('admin-team', this)">02. Admin</button>
                        <button class="team-btn" id="tab-front" role="tab" aria-selected="false" aria-controls="frontend-team" tabindex="-1" onclick="toggleTeam('frontend-team', this)">03. Front</button>
                        <button class="team-btn" id="tab-back" role="tab" aria-selected="false" aria-controls="backend-team" tabindex="-1" onclick="toggleTeam('backend-team', this)">04. Back</button>
                        <button class="team-btn" id="tab-bio" role="tab" aria-selected="false" aria-controls="biometrics-team" tabindex="-1" onclick="toggleTeam('biometrics-team', this)">05. Bio</button>
                        <button class="team-btn" id="tab-qa" role="tab" aria-selected="false" aria-controls="testing-team" tabindex="-1" onclick="toggleTeam('testing-team', this)">06. QA</button>
                    </div>

                    <div id="team-details">
                        <!-- Team Leads -->
                        <div id="team-leads" class="team-detail active" role="tabpanel" aria-labelledby="tab-leads">
                        ...
                        <!-- Admin Team -->
                        <div id="admin-team" class="team-detail" role="tabpanel" aria-labelledby="tab-admin">
                        ...
                        <!-- Frontend Team -->
                        <div id="frontend-team" class="team-detail" role="tabpanel" aria-labelledby="tab-front">
                        ...
                        <!-- Backend Team -->
                        <div id="backend-team" class="team-detail" role="tabpanel" aria-labelledby="tab-back">
                        ...
                        <!-- Biometrics Team -->
                        <div id="biometrics-team" class="team-detail" role="tabpanel" aria-labelledby="tab-bio">
                        ...
                        <!-- Testing Team -->
                        <div id="testing-team" class="team-detail" role="tabpanel" aria-labelledby="tab-qa">
    ...
    <script>
        function toggleTeam(teamId, btn) {
            ...
            // Toggle buttons and set WAI-ARIA states
            buttons.forEach(b => {
        ...
        // Keyboard navigation for WAI-ARIA tab list
        document.querySelector('.team-controls').addEventListener('keydown', function(e) {
            ...
            if (nextIndex !== activeIndex) {
                ...
                nextBtn.focus();
                nextBtn.click(); // Selects the tab and toggles panel visibility
            }
        });
