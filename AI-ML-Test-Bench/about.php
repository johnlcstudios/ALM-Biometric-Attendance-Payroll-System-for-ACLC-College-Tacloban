...
<body>
            ...
            <div class="billboard-content">
                ...
                <div class="team-container">
                    ...
                    <div class="team-controls" role="tablist" aria-label="Developer Teams">
                        <button id="tab-team-leads" class="team-btn active" role="tab" aria-selected="true" aria-controls="team-leads" tabindex="0" onclick="toggleTeam('team-leads', this)">01. Leads</button>
                        <button id="tab-admin-team" class="team-btn" role="tab" aria-selected="false" aria-controls="admin-team" tabindex="-1" onclick="toggleTeam('admin-team', this)">02. Admin</button>
                        <button id="tab-frontend-team" class="team-btn" role="tab" aria-selected="false" aria-controls="frontend-team" tabindex="-1" onclick="toggleTeam('frontend-team', this)">03. Front</button>
                        <button id="tab-backend-team" class="team-btn" role="tab" aria-selected="false" aria-controls="backend-team" tabindex="-1" onclick="toggleTeam('backend-team', this)">04. Back</button>
                        <button id="tab-biometrics-team" class="team-btn" role="tab" aria-selected="false" aria-controls="biometrics-team" tabindex="-1" onclick="toggleTeam('biometrics-team', this)">05. Bio</button>
                        <button id="tab-testing-team" class="team-btn" role="tab" aria-selected="false" aria-controls="testing-team" tabindex="-1" onclick="toggleTeam('testing-team', this)">06. QA</button>
                    </div>

                    <div id="team-details">
                        <!-- Team Leads -->
                        <div id="team-leads" class="team-detail active" role="tabpanel" aria-labelledby="tab-team-leads">
                        ...
                        <!-- Admin Team -->
                        <div id="admin-team" class="team-detail" role="tabpanel" aria-labelledby="tab-admin-team">
                        ...
                        <!-- Frontend Team -->
                        <div id="frontend-team" class="team-detail" role="tabpanel" aria-labelledby="tab-frontend-team">
                        ...
                        <!-- Backend Team -->
                        <div id="backend-team" class="team-detail" role="tabpanel" aria-labelledby="tab-backend-team">
                        ...
                        <!-- Biometrics Team -->
                        <div id="biometrics-team" class="team-detail" role="tabpanel" aria-labelledby="tab-biometrics-team">
                        ...
                        <!-- Testing Team -->
                        <div id="testing-team" class="team-detail" role="tabpanel" aria-labelledby="tab-testing-team">
    ...
    <script>
        function toggleTeam(teamId, btn) {
            ...
            // Toggle buttons & update WAI-ARIA states
            buttons.forEach(b => {
        ...
        // Keyboard arrow key navigation for tablist
        document.querySelector('.team-controls')?.addEventListener('keydown', (e) => {
            const buttons = Array.from(document.querySelectorAll('.team-btn'));
