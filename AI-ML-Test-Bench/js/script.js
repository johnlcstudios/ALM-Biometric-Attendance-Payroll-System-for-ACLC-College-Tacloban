    ...
    tbody.innerHTML = paginatedEmployees.map(emp => {
        ...
        const buttonsHtml = isResigned ? `
            <div class="action-buttons">
                <button type="button" class="btn-icon text-success" title="Reinstate Employee" aria-label="Reinstate Employee" onclick="reinstateEmployee('${emp.id}', '${escapeHTML(emp.full_name)}')"><i class="fas fa-user-check" aria-hidden="true"></i></button>
                <button type="button" class="btn-icon" title="Edit Employee" aria-label="Edit Employee" onclick="editEmployee('${emp.id}')"><i class="fas fa-edit" aria-hidden="true"></i></button>
            </div>
        ` : `
            <div class="action-buttons">
                <button type="button" class="btn-icon" title="Edit Employee" aria-label="Edit Employee" onclick="editEmployee('${emp.id}')"><i class="fas fa-edit" aria-hidden="true"></i></button>
                <button type="button" class="btn-icon text-danger" title="Delete Employee" aria-label="Delete Employee" onclick="deleteEmployee('${emp.id}')"><i class="fas fa-trash" aria-hidden="true"></i></button>
            </div>
        `;
        ...
        <tr>
            ...
            <td>
                <div class="table-actions">
                    <button type="button" class="btn-icon" title="View Details" aria-label="View Details" onclick="viewAttendanceDetails(${log.id})"><i class="fas fa-eye" aria-hidden="true"></i></button>
                    <button type="button" class="btn-icon delete" title="Flag/Report" aria-label="Flag or Report Attendance" onclick="flagAttendance(${log.id})"><i class="fas fa-flag" aria-hidden="true"></i></button>
                </div>
            </td>
        </tr>
    `;
    ...
    if (categoriesBody) {
        categoriesBody.innerHTML = categories.map(c => `
            <tr>
                ...
                <td>Yes</td>
                <td>
                    <button type="button" class="btn-icon delete" title="Delete Category" aria-label="Delete Allowance Category" onclick="deleteAllowanceCategory(${c.id})"><i class="fas fa-trash" aria-hidden="true"></i></button>
                </td>
            </tr>
    ...
    if (breakdownBody) {
        breakdownBody.innerHTML = breakdown.map(b => `
            <tr>
                ...
                <td>
                    <button type="button" class="btn-icon delete" title="Remove Assignment" aria-label="Remove Employee Allowance Assignment" onclick="deleteEmployeeAllowance(${b.id})"><i class="fas fa-trash" aria-hidden="true"></i></button>
                </td>
            </tr>
    ...
    if (categoriesBody) {
        categoriesBody.innerHTML = categories.map(c => `
            <tr>
                ...
                <td>
                    <button type="button" class="btn-icon delete" title="Delete Category" aria-label="Delete Deduction Category" onclick="deleteDeductionCategory(${c.id})"><i class="fas fa-trash" aria-hidden="true"></i></button>
                </td>
            </tr>
        `).join('') || '<tr><td colspan="5" class="text-center">No categories found.</td></tr>';
    }
    ...
    if (breakdownBody) {
        breakdownBody.innerHTML = breakdown.map(b => `
            <tr>
                ...
                <td>${b.effective_date || '---'}</td>
                <td>
                    <button type="button" class="btn-icon delete" title="Remove Assignment" aria-label="Remove Employee Deduction Assignment" onclick="deleteEmployeeDeduction(${b.id})"><i class="fas fa-trash" aria-hidden="true"></i></button>
                </td>
            </tr>
        `).join('') || '<tr><td colspan="5" class="text-center">No assignments found.</td></tr>';
    }
