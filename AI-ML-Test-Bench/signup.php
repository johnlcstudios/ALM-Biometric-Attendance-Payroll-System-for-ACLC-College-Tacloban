            ...
            <form id="signupForm">
                ...
                <div class="form-group">
                    <div class="input-wrapper">
                        ...
                        <i class="fas fa-eye toggle-password" data-target="password" role="button" tabindex="0" aria-label="Toggle password visibility"></i>
                ...
                <div class="form-group">
                    <div class="input-wrapper">
                        ...
                        <i class="fas fa-eye toggle-password" data-target="confirm_password" role="button" tabindex="0" aria-label="Toggle password visibility"></i>
