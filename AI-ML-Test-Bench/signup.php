        ...
        document.getElementById('signupForm').onsubmit = async (e) => {
            ...
            if (result.success) {
                Swal.fire({
                    icon: 'success',
                    title: 'Welcome!',
                    html: `Registration successful!<br><strong>Company Code:</strong> ${result.company_code || 'Auto-generated'}<br><br><strong>Your Role:</strong> Admin<br>Redirecting to dashboard...`,
                    customClass: {
                        popup: 'glass-modal',
                        container: 'glass-backdrop'
                    },
