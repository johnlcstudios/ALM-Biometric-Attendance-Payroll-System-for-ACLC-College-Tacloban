                            ...
                            <form onsubmit="changePassword(event)">
                                <div class="form-group-custom">
                                    ...
                                    <div class="input-wrapper">
                                        <input type="password" name="current_password" id="current_password" class="password-field form-control-large-gray" required>
                                ...
                                <div class="form-group-custom">
                                    ...
                                    <div class="input-wrapper">
                                        <input type="password" name="new_password" id="new_password" class="password-field form-control-large-gray" required oninput="checkPasswordStrength()">
                                ...
                                <div class="form-group-custom">
                                    ...
                                    <div class="input-wrapper">
                                        <input type="password" name="confirm_password" id="confirm_password" class="password-field form-control-large-gray" required>
